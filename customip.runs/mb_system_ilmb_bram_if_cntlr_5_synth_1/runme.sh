...
HD_PWD='/opt/Xilinx/Vivado/2018.2/customip/customip.runs/mb_system_ilmb_bram_if_cntlr_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_system_ilmb_bram_if_cntlr_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_system_ilmb_bram_if_cntlr_5.tcl
