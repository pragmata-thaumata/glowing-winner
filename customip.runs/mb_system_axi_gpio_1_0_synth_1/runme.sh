...
HD_PWD='/opt/Xilinx/SDK/2018.2/0projects/customip/customip.runs/mb_system_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_system_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_system_axi_gpio_1_0.tcl
